...
//     @Get(':id/episodes')
//     getEpisode(@Param('id') podcastId: number) {
...
//     @Post(':id/episodes')
//     createEpisode(@Param('id') podcastId: number, @Body() episodeData) {
...
//     removeEpisode(@Param('id') podcastId: number, @Param('episodeId') episodeId: number) {
//         return this.podcastsService.deleteEpisode(podcastId, episodeId);
//     }

//     @Patch(':id')
//     patchPodcast(@Param('id') podcastId: number, @Body() updatedPodcastData) {
//         return this.podcastsService.updatePodcast(podcastId, updatedPodcastData);
//     }

//     @Patch(':id/episodes/:episodeId')
//     patchEpisode(@Param('id') podcastId: number, @Param('episodeId') episodeId: number, @Body() updatedEpisodeData) {
